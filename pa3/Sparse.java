...
// This program will read a file and input the values into a sparsed matrix and perform matrix operations
import java.io.*;
...
public class Sparse{
        public static void main(String[] args) throws IOException{
                ...
                String line = null;
                String[] token = null;
                int n, lineNumber = 0, lineA, lineB;
                if(args.length < 2){
